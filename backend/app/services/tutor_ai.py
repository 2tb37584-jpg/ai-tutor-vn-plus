...
def _analysis_prompt_with_skill_contract() -> str:
    ...
    return (
        ...
        "the higher-level target primary. For rational-expression simplification with a domain "
        ...
        "the identity objective as primary. Choose the smallest directly relevant skill set.\n"
