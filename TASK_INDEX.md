...
| M05-04B3A | Tutor Engine | Add deterministic answer-leakage detector | ACTIVE | Yes, small |
| M05-04B3B | Tutor Engine | Enforce runtime answer-leakage guard in tutor API | BACKLOG | Yes, small |
